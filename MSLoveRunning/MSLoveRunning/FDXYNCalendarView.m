...
#define SCREEN_RAT (ScreenW/320.0f)
...
@implementation FDXYNCalendarView
- (NSDate *)today {
    if (!_today) {
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        //内容区的背景
        _contentBgView = [[UIView alloc] initWithFrame:CGRectMake((ScreenW-UNIT_WIDTH*kCol)/2.0, 100, UNIT_WIDTH*kCol, 42+UNIT_WIDTH*kCol+50)];
